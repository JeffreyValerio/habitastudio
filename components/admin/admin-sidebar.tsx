...
import { LayoutDashboard, Package, Wrench, FolderKanban, FileText, Receipt, LogOut, Home, Users, Settings, Clock } from "lucide-react";
...
const navigation = [
  ...
  { name: "Tiempo", href: "/admin/time-management", icon: Clock },
];
